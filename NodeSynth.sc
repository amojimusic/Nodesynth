...
NodeSynth {
	var <>window, <>osc1, <>osc2, <>oscWidth = 200, <>oscHeight = 150, <>windowWidth = 850, <>windowHeight = 600, windowX = 250, windowY = 100, <>n0, <>n1, <>n2, <>n3, <>n4, <>n5, <>n6, <>n7, <>n8, <>n9, <>n10, <>n11, <>n12, <>n13, <>n14, <>n15, <>n16, <>n17, <>wave1, <>wave2, <>voice1, <>voice2, <>voice3, <>voice4, <>voice5, <>voice6, <>voice7, <>voice8, <>synthDef, <>synth, <>synthName, <>synthDefFunc, <>nDef, <>fadeTime, <>osc1AmpSlider, osc2AmpSlider;
	...
	*new {
	...
	inst {
		...
		osc2.n7 = n16;
		osc2.n8 = n17;
		osc2.makeView(oscWidth + 30 + 10, 20, oscWidth, oscHeight);
		wave2 = osc2.makeWave;
